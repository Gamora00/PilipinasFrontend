...
export const politicians = [
  { slug: 'maria-delgado',  name: 'Maria S. Delgado',  role: 'Senador',       party: 'Reform Coalition', region: 'Nationwide',  attendance: '94%', bills: '37', promises: '82%' },
  ...
  { slug: 'benigno-castro', name: 'Benigno R. Castro', role: 'Gobernador',    party: 'Independent',      region: 'Iloilo',      attendance: '89%', bills: '9',  promises: '65%' },
  { slug: 'joselito-reyes', name: 'Joselito P. Reyes', role: 'Senador',       party: "People's Front",   region: 'Nationwide',  attendance: '85%', bills: '28', promises: '74%' },
  { slug: 'anna-lim',       name: 'Anna V. Lim',       role: 'Konsehal',      party: 'Reform Coalition', region: 'Quezon City', attendance: '98%', bills: '15', promises: '91%' },
]
